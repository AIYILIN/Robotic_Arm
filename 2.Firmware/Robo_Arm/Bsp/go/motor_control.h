...
typedef struct
{
    ...
    unsigned short mode;                // 0:空闲, 1:开环转动, 2:闭环FOC控制
    //实际给FOC的指令力矩为：
    // K_P*delta_Pos + K_W*delta_W + T
...
// #define SET_485_DE_RE_UP() HAL_GPIO_WritePin(RS485_DE_RE_GPIO_Port, RS485_DE_RE_Pin, GPIO_PIN_SET)
// #define SET_485_DE_RE_DOWN() HAL_GPIO_WritePin(RS485_DE_RE_GPIO_Port, RS485_DE_RE_Pin, GPIO_PIN_RESET)
...
extern MOTOR_send go_cmd2;
extern MOTOR_recv go_rec2;
extern MOTOR_send go_cmd3;
extern MOTOR_recv go_rec3;
